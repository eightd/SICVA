...
public class ControladorLogin implements Serializable {
	...
	private static final long serialVersionUID = -3207800023724134563L;
	private String pwd;
	private String msg;
	private String user;
...
public boolean tieneRol4(String rol) {
	...
	public void validate() {
		...
		if (res != null) {
			...
			System.out.println("este es el estado "+Rol);
			if(contra_esta==0){
				...
				redireccionar("contraseña.xhtml");
				return;
			}if(contra_esta==1){
				subirValorSesion("nombre", user);
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN,
					"Datos Incorrectos O credenciales incorrectas", "Verifica tus datos"));
