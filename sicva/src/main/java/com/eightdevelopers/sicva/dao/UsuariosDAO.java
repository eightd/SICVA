...
public class UsuariosDAO {
	...
	public List<UsuariosDTO> listarUsuarios() {
		try {
			...
			conexionBD.abrir();
			Connection connection = conexionBD.getConexion();
			PreparedStatement ps = connection.prepareStatement("SELECT usuarios.id_usuarios,usuarios.nombre,usuarios.apellido_paterno,usuarios.apellido_materno,usuarios.usuario,usuarios.contrasenia,"
					+ " usuarios.contrasenia_estado,usuarios.id_lic,licenciaturas.descripcion,usuarios.roles_id_rol,roles.descripcion,"
	...
	public List<LicenciaturaDTO> listarlicenciatura() {
		try {
			...
			conexionBD.abrir();
			Connection connection = conexionBD.getConexion();
			PreparedStatement ps = connection.prepareStatement("SELECT * FROM licenciaturas WHERE estado=1");
